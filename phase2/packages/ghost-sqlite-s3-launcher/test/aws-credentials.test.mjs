...
test('buildAwsConfigFile produces a valid credential_process profile block', () => {
  const content = buildAwsConfigFile({
    ...
    roleArn: 'arn:aws:iam::123456789012:role/ghost-phase2-app-runtime',
  ...
  assert.match(
    content,
    /^credential_process = node \/home\/ghost\/node_modules\/@ghost-phase2\/ghost-sqlite-s3-launcher\/src\/assume-role-credential-process\.mjs arn:aws:iam::123456789012:role\/ghost-phase2-app-runtime us-east-1$/m
  );
});
